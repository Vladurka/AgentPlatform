...
public record UpdateAgentRequest(string Name, string? Description, string Instructions);
public record AgentDto(Guid Id, string Name, string? Description, string Instructions, string EmbedToken, string Status, DateTime CreatedAt);
